    ...
    <div className="bg-white dark:bg-[#1E293B] rounded-3xl p-4 shadow-sm border border-slate-100 dark:border-slate-700/80 mx-4 transition-colors">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-xs font-black text-[#183153] dark:text-white uppercase tracking-wide">
              Meta Diaria
            </h3>
        ...
        <div className="text-right">
          <span className="text-sm font-black text-[#183153] dark:text-white">
      ...
      {/* Progress Bar */}
      <div className="w-full h-2.5 bg-slate-100 dark:bg-slate-900 rounded-full overflow-hidden mt-2 relative">
        <div 
      ...
      <div className="mt-3 flex items-center justify-between pt-1">
        ...
        {!isCompleted ? (
          <button
            ...
            className="text-xs font-black px-3.5 py-1.5 rounded-xl bg-[#F05C54] hover:bg-[#E04B43] text-white shadow-sm transition-transform active:scale-95"
          >
            Completar meta →
          </button>
        ) : (
