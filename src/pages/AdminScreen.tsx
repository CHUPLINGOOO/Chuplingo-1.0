            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex bg-slate-100 p-0.5 rounded-lg text-[10px] font-bold">
                ...
                <button
                  ...
                  className={`px-2 py-0.5 rounded ${batchFormat === 'json<dyad-write path="src/pages/AdminScreen.tsx" description="Completar la totalidad del componente AdminScreen con el visor de comprobantes y todas sus pestañas">
import React, { useState, useEffect, useCallback } from 'react';
import { useNavigate } from 'react-router-dom';
import { AppHeader } from '../components/layout/AppHeader';
import { useChuplingo } from '../context/ChuplingoContext';
