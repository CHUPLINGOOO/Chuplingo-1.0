            ...
            {isLoadingRequests ? (
              ...
              pendingRequests.map(req => (
                <div key={req.id} className="bg-white rounded-2xl p-4 shadow-sm border border-amber-200 flex flex-col gap-2.5">
                  ...
                  <div className="flex items-center<dyad-write path="src/pages/AdminScreen.tsx" description="Guardia de seguridad y gestión completa de administración basada en profiles.role">
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { AppHeader } from '../components/layout/AppHeader';
import { useChuplingo } from '../context/ChuplingoContext';
