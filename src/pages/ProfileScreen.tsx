    ...
    <div className="flex flex-col gap-4">
      ...
      {showAvatarModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-xs flex items-center justify-center z-50 p-4 animate-in fade-in duration-150">
          <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-sm w-full p-5 shadow-2xl border border-slate-200 dark:border-slate-700 flex flex-col gap-4">
      ...
      {/* Profile Card */}
      <div className="mx-4 -mt-6 bg-white dark:bg-slate-800 rounded-3xl p-5 shadow-sm border border-slate-100 dark:border-slate-700 relative z-20 flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-3 gap-2 w-full mt-4 pt-3 border-t border-slate-100 dark:border-slate-700">
          <div className="p-2 rounded-xl bg-orange-50 dark:bg-orange-950/40">
            ...
            <span className="text-xs font-black text-[#183153] dark:text-white block">{user.rachaActual} días</span>
      ...
      <div className="px-4">
        ...
        >
          ...
          <div className={`w-12 h-6 rounded-full transition-colors relative ${isDarkMode ? 'bg-[#7354D9]' : 'bg-slate-300'}`}>
            <div className={`w-4 h-4 rounded-full bg-white transition-transform absolute top-1 ${isDarkMode ? 'left-7' : 'left-1'}`} />
          </div>
        </div>
      </div>
      ...
      <div className="px-4 flex flex-col gap-3">
        ...
        {showSecurityModal && (
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-4 border border-slate-200 dark:border-slate-700 flex flex-col gap-4 animate-in fade-in">
            {/* Change Email */}
